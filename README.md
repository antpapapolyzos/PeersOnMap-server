...
## Κατασκευή του κώδικα τοπικά στον υπολογιστή σας
 ...
 3. Καταβάστε (download zip) τον κώδικα από [εδώ](https://github.com/antpapapolyzos/PoM-server.git)
 4. Αποσυμπιέστε τον φάκελο
 5. Αλλάξτε το όνομα του root directory (PoM-server-master) σε pom
